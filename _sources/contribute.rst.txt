...
#. The html output is committed and push the ``gh-branch`` branch of https://github.com/hyperspy/hyperspy-bundle
#. The html output is deployed to https://hyperspy.org/hyperspy-bundle
